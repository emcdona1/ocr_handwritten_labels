...
def buildCorpus(destination):
    ...
    resultXpathsWithFileName.append(("//td/a/span[@class='name']/i[@class='genus']/text()", "ScienteficWords.txt"))
    resultXpathsWithFileName.append(("//td/a/span[@class='name']/i[@class='species']/text()", "ScienteficWords.txt"))
