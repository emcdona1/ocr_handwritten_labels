...
def compare_ground_truth(ground_truth, predicted_languages: str):
    ...
    # prints 'Match found' when a detected barcode matches a ground truth barcode
    # this is for instances where the ground truth occurrence file has additional labels that langauge
    # detection was not run on
    ...
    print(num_correct, "correct language detections")
    print(num_incorrect, "incorrect language detections")
